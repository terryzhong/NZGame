...
void UPortControlBPLibrary::Vibration(MotorPosition _motorPosition, StereotypedMode _vibraMode)
{
	if (serialIsOpen) 
	{
		...
		UPortControlBPLibrary::CustomizeVibration(_motorPosition, uint8(_vibraMode));
	}
}
