...
void ANZWeaponAttachment::PlayFiringEffects()
{
    ...
    {
        if (ImpactEffect.IsValidIndex(NZOwner->FireMode) && ImpactEffect[NZOwner->FireMode] != NULL)
        {
            ...
            {
                ImpactEffect[NZOwner->FireMode].GetDefaultObject()->SpawnEffect(GetWorld(), FTransform(ImpactHit.Normal.Rotation(), ImpactHit.Location), ImpactHit.Component.Get(), NULL, NZOwner->Controller);
